    ...
    if (answer) {
        ...
        if (currentQuiz < quizData.length) {
            ...
            quiz.innerHTML = `
                ...
                <div style="width:450px display: block; justify-content: center; text-align: center;"><iframe allow="fullscreen" frameBorder="0" height="240" src="https://giphy.com/embed/U4dLVG7d5KsqnN8pBG/video" width="480"></iframe></div>
